...
funcionCurva = matlabFunction(eqn);


zonaDerrapeX1 = [];

if(puntosCriticos(1)>X0)
    for punto = puntosCriticos(1):-1:X0
        zonaDerrapeX1 = [punto zonaDerrapeX1];
        if(calc_radius(eqn, punto)>=50)
            break;
        end
    end
    zonaDerrapeY1 = funcionCurva(zonaDerrapeX1);
...
if(puntosCriticos(2)<XF)
    for punto = puntosCriticos(2):-1:puntosCriticos(1)
        zonaDerrapeX2 = [punto zonaDerrapeX2];
        if(calc_radius(eqn,punto)>=50)
            break;
        end
    end
   
    zonaDerrapeY2 = funcionCurva(zonaDerrapeX2); 
